...
> Índice de la bitácora. Una línea por unidad de trabajo.
> Es el único archivo de `bitacora/` que se lee al inicio de cada sesión.
> El detalle vive en el `.md` de cada dominio; abrir solo el que se va a tocar.

| Dominio | Archivo | Última sesión | Pendiente principal |
|---|---|---|---|
...
**Nota:** el estado inicial de estos archivos se reconstruyó a partir del historial de commits
(agosto 2026 hacia atrás), así que puede estar incompleto. Se completa a medida que se trabaja.
